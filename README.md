...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <p>🔹 Delivered features adhering to design systems and user-centric principles.</p>
      <p>🔹 Mentored and supported team members for project excellence.</p>
    </td>
  </tr>
  <tr>
    <td>
      <h3>Samsung Electronics</h3>
      <p><strong>AV Product Manager</strong></p>
      <p>🔹 Initiated Samsung Smart Kino & Smart Music projects.</p>
      <p>🔹 Implemented Global Cost Optimization System.</p>
      <p>🔹 Established Samsung University project for online training.</p>
      <p>🔹 Developed TV Accessories business in Ukraine.</p>
      <p>🔹 Negotiated with National retail for DAV products.</p>
      <p>🔹 Provided P&L calculations and product pricing strategy.</p>
      <p>🔹 Entered market with new products like Wireless Audio Docking Stations.</p>
    </td>
    <td>
      <h3>Angular Meetup Lviv</h3>
      <p><strong>Organizer</strong></p>
      <p>🔹 Conducted location scouting and negotiated venue partnerships.</p>
      <p>🔹 Led the search for expert speakers and motivated industry professionals.</p>
      <p>🔹 Delivered keynote presentations on Angular-related topics.</p>
      <p>🔹 Coordinated event logistics, including scheduling and attendee management.</p>
      <p>🔹 Created Telegram and Facebook Channels for Angular Tech news updates.</p>
    </td>
    <td>
      <h3>Lohika</h3>
      <p><strong>Full Stack Developer</strong></p>
      <p>🔹 Built performant data-heavy UI features.</p>
      <p>🔹 Enhanced backend performance with optimized SQL queries.</p>
      <p>🔹 Promoted to Senior FE Developer.</p>
    </td>
  </tr>
  <tr>
    <td>
      <h3>Ischia Ltd. Ristorante La Perla of Washington</h3>
      <p><strong>Administrative Manager</strong></p>
      <p>🔹 Handled restaurant daily operations including secretarial duties.</p>
      <p>🔹 Worked on confidential matters (contracts, employees, lawyers, brokers, accountants).</p>
      <p>🔹 Assisted owner with customer relations.</p>
      <p>🔹 Managed a team of 7 to 15 people depending on seasonality.</p>
      <p>🔹 Handled customer flow in busy times up to 300 people.</p>
      <p>🔹 Brought more than 20 regular customers through good service.</p>
    </td>
    <td>
      <h3>ngMates</h3>
      <p><strong>Mentor / Project Manager</strong></p>
      <p>бер 2017 р. – тра 2017 р. · 3 міс.</p>
      <p><strong>Освіта</strong></p>
      <p>🔹 Organized and Led Angular Lab Workshops:</p>
      <ul>
        <li>Secured venues to host hands-on Angular workshops, ensuring a collaborative and conducive learning environment.</li>
        <li>Provided direct mentorship and guided participants through real-world Angular projects, helping them apply learned concepts to practical scenarios.</li>
        <li>Kicked off each session with a review of Angular principles, reinforcing core concepts and ensuring a strong foundation for participants.</li>
        <li>Promoted teamwork and collaboration, fostering an environment where participants could learn from each other and work together to solve complex problems.</li>
      </ul>
    </td>
    <td>
      <h3>EPAM Systems</h3>
      <p><strong>Angular Developer</strong></p>
      <p>🔹 Participated in application architecture design.</p>
...
## P.S. Hey, full disclosure — I’m more of a GitLab fan. Here’s one of my recent activity! I just moved in July, so my commits have been a bit sparse since then. 🤓🚀
